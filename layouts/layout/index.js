    ...
    <>
      ...
      >
        <div className="wrapper">
          <div className="main w-full bg-gray-50 dark:bg-black text-gray-900 dark:text-white" style={{ minHeight: '100vh', backgroundImage: `url("/images/background${theme === 'light' ? '_white' : ''}.png")`, backgroundSize: 'cover' }}>
            <Navbar />
